...
A professional CLI (Command Line Interface) application built with Python and SQLite to track gym progress.
...
2\. Navigate to the folder: `cd GymWorkoutLog`

3\. Run the application: `python gym\_log.py`
